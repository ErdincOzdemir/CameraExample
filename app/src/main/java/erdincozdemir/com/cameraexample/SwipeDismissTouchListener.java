...
public class SwipeDismissTouchListener implements View.OnTouchListener {
    ...
    public interface DismissCallbacks {
         ...
         */
        void onDismiss(View view, Object token, SwipeDirection direction);
    }
                    ...
                    mView.animate()
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    SwipeDirection direction = finalDismissRight ? SwipeDirection.RIGHT : SwipeDirection.LEFT;
                                    performDismiss(direction);
                                }
                            });
                } else if (mSwiping) {
                    // cancel
    ...
    private void performDismiss(final SwipeDirection direction) {
